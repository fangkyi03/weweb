...
const fileContent = fs.readFileSync(path.join(__dirname,'./engine.js'),'utf-8')
const engine = jjencode('$',fileContent)
fs.writeFileSync(path.join(__dirname,'./engineCode.js'),'eval(`' + engine + '`)')