...
// miniprogram-demo/miniprogram/app.json
var require_app = __commonJS({
  "miniprogram-demo/miniprogram/app.json"(exports, module) {
    module.exports = {
      pages: [
...
var require_scroll_view3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/scroll-view/scroll-view.js"() {
    require_scroll_view();
...
var require_swiper3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/swiper/swiper.js"() {
    require_swiper();
    require_swiper2();
    Page({
...
var require_picker3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/picker/picker.js"() {
    require_picker();
    require_picker2();
    Page({
...
var require_textarea3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/textarea/textarea.js"() {
    require_textarea();
    require_textarea2();
    Page({
...
var require_navigate3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/navigator/navigate.js"() {
    require_navigate();
    require_navigate2();
    Page({
...
var require_redirect3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/navigator/redirect.js"() {
    require_redirect();
    require_redirect2();
    Page({
...
var require_movable_view3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/movable-view/movable-view.js"() {
...
var require_cover_view3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/cover-view/cover-view.js"() {
    require_cover_view();
    require_cover_view2();
    Page({
...
var require_rich_text3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/rich-text/rich-text.js"() {
    require_rich_text();
    require_rich_text2();
...
var require_picker_view3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/picker-view/picker-view.js"() {
    require_picker_view();
...
var require_camera3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/camera/camera.js"() {
    require_camera();
    require_camera2();
    var vs2 = `
...
var require_camera_scan_code3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/camera-scan-code/camera-scan-code.js"() {
...
var require_map_styles3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/map-styles/map-styles.js"() {
    require_map_styles();
    require_map_styles2();
    Page({
...
var require_live_player3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/live-player/live-player.js"() {
    require_live_player();
...
var require_live_pusher3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/live-pusher/live-pusher.js"() {
    require_live_pusher();
...
var require_aria_component3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/aria-component/aria-component.js"() {
...
var require_doc_web_view3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/doc-web-view/doc-web-view.js"() {
...
var require_open_data3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/open-data/open-data.js"() {
    require_open_data();
    require_open_data2();
    Page({
...
var require_web_view3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/web-view/web-view.js"() {
    require_web_view();
    require_web_view2();
    Page({
...
var require_editor3 = __commonJS({
  "miniprogram-demo/miniprogram/page/component/pages/editor/editor.js"() {
    require_editor();
    require_editor2();
    Page({
...
var require_example2 = __commonJS({
...
var require_slideview2 = __commonJS({
...
var require_article2 = __commonJS({
...
var require_gallery2 = __commonJS({
...
var require_loadmore2 = __commonJS({
...
var require_preview2 = __commonJS({
...
var require_msg_text2 = __commonJS({
...
var require_msg_text_primary2 = __commonJS({
...
var require_msg_success2 = __commonJS({
...
var require_msg_fail2 = __commonJS({
...
var require_navbar3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/navbar/navbar.js"() {
    require_navbar();
    require_navbar2();
    var sliderWidth = 96;
...
var require_form_page3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/form-page/form-page.js"() {
    require_form_page();
    require_form_page2();
    Component({
...
var require_half_screen_dialog2 = __commonJS({
...
var require_actionsheet2 = __commonJS({
...
var require_toptips3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/toptips/toptips.js"() {
    require_toptips();
    require_toptips2();
    Page({
...
var require_searchbar2 = __commonJS({
...
var require_video_swiper2 = __commonJS({
...
var require_index_list2 = __commonJS({
...
var require_select_text2 = __commonJS({
...
var require_barrage2 = __commonJS({
...
var require_wxml_to_canvas3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/wxml-to-canvas/wxml-to-canvas.js"() {
...
var require_telescopic3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/telescopic/telescopic.js"() {
    require_telescopic();
    require_telescopic2();
    Page({
...
var require_linebreak3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/linebreak/linebreak.js"() {
    require_linebreak();
    require_linebreak2();
    Page({
...
var require_sidenavigation3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/sidenavigation/sidenavigation.js"() {
...
var require_freelayout3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/freelayout/freelayout.js"() {
    require_freelayout();
    require_freelayout2();
    Page({
...
var require_layeredpresentation3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/layeredpresentation/layeredpresentation.js"() {
...
var require_horizontalexpansion3 = __commonJS({
  "miniprogram-demo/miniprogram/page/weui/example/horizontalexpansion/horizontalexpansion.js"() {
...
var require_canvas_2d2 = __commonJS({
...
init_canvas();
require_ad3();
require_movable_view3();
require_cover_view3();
require_rich_text3();
require_picker_view3();
require_camera3();
require_camera_scan_code3();
require_map_styles3();
require_live_player3();
require_live_pusher3();
require_aria_component3();
require_API3();
require_cloud3();
require_doc_web_view3();
require_open_data3();
require_web_view3();
require_editor3();
init_example();
...
init_select_text();
init_barrage();
require_wxml_to_canvas3();
require_telescopic3();
require_linebreak3();
require_sidenavigation3();
require_pagination3();
require_freelayout3();
require_layeredpresentation3();
require_horizontalexpansion3();
init_canvas_2d();
init_webgl();
