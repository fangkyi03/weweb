...
var require_base = __commonJS({
  "taro/dist/base.wxml"() {
    ...
    registerComponent("tmpl_0_text", {
      ...
      template: `<div>
        <wx-text :selectable="xs.b(i.selectable,false)" :space="i.space" :decode="xs.b(i.decode,false)" :user-select="xs.b(i.userSelect,false)" :style="i.st" :class="i.cl" bindtap="eh" :id="i.uid" >
    ...
    registerComponent("tmpl_0_input_focus", {
      ...
      template: `<div>
        <wx-input :value="i.value" :type="xs.b(i.type,'')" :password="xs.b(i.password,false)" :placeholder="i.placeholder" :placeholder-style="i.placeholderStyle" :placeholder-class="xs.b(i.placeholderClass,'input-placeholder')" :disabled="i.disabled" :maxlength="xs.b(i.maxlength,140)" :cursor-spacing="xs.b(i.cursorSpacing,0)" :focus="xs.b(i.focus,false)" :confirm-type="xs.b(i.confirmType,'done')" :confirm-hold="xs.b(i.confirmHold,false)" :cursor="xs.b(i.cursor,i.value.length)" :selection-start="xs.b(i.selectionStart,-1)" :selection-end="xs.b(i.selectionEnd,-1)" bindinput="eh" bindfocus="eh" bindblur="eh" bindconfirm="eh" :name="i.name" :always-embed="xs.b(i.alwaysEmbed,false)" :adjust-position="xs.b(i.adjustPosition,true)" :hold-keyboard="xs.b(i.holdKeyboard,false)" bindkeyboardheightchange="eh" :style="i.st" :class="i.cl" bindtap="eh" :id="i.uid" >
    ...
    registerComponent("tmpl_0_input_blur", {
      ...
      template: `<div>
        <wx-input :value="i.value" :type="xs.b(i.type,'')" :password="xs.b(i.password,false)" :placeholder="i.placeholder" :placeholder-style="i.placeholderStyle" :placeholder-class="xs.b(i.placeholderClass,'input-placeholder')" :disabled="i.disabled" :maxlength="xs.b(i.maxlength,140)" :cursor-spacing="xs.b(i.cursorSpacing,0)" :confirm-type="xs.b(i.confirmType,'done')" :confirm-hold="xs.b(i.confirmHold,false)" :cursor="xs.b(i.cursor,i.value.length)" :selection-start="xs.b(i.selectionStart,-1)" :selection-end="xs.b(i.selectionEnd,-1)" bindinput="eh" bindfocus="eh" bindblur="eh" bindconfirm="eh" :name="i.name" :always-embed="xs.b(i.alwaysEmbed,false)" :adjust-position="xs.b(i.adjustPosition,true)" :hold-keyboard="xs.b(i.holdKeyboard,false)" bindkeyboardheightchange="eh" :style="i.st" :class="i.cl" bindtap="eh" :id="i.uid" >
            ...
            Object(_Users_lv_Desktop_tarodemo_taro_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["a"])(Index2, [{
              ...
              value: function render() {
                ...
                return /* @__PURE__ */ Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__["jsxs"])(_tarojs_components__WEBPACK_IMPORTED_MODULE_7__["e"], {
                  ...
                  }), /* @__PURE__ */ Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__["jsx"])(_tarojs_components__WEBPACK_IMPORTED_MODULE_7__["b"], {}), /* @__PURE__ */ Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__["jsx"])(_tarojs_components__WEBPACK_IMPORTED_MODULE_7__["a"], {
                    type: "primary",
                    onClick: this.onAdd,
