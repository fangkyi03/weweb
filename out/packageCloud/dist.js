...
var require_doc_web_view = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/doc-web-view/doc-web-view.wxml"() {
    ...
    page.template = `<div>
        <wx-web-view src="https://developers.weixin.qq.com/miniprogram/dev/wxcloud/basis/getting-started.html" >
...
var require_user_authentication = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/user-authentication/user-authentication.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'User Authentication'}" >
        ...
        <wx-button type="primary" bindtap="onGetOpenid" :loading="loading" >
            \u83B7\u53D6OpenID
        </wx-button>
...
var require_get_wx_context = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/get-wx-context/get-wx-context.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'getWXContext'}" >
        ...
        <wx-text class="page-body-text" >
            \u8FD4\u56DE\u5185\u5BB9\u5305\u62EC\u7528\u6237OpenID\u3001\u5C0F\u7A0B\u5E8FAppID\u4EE5\u53CA\u7528\u6237UnionID\uFF08\u6EE1\u8DB3UnionID\u83B7\u53D6\u6761\u4EF6\u65F6\uFF09
        </wx-text>
        ...
        <wx-button type="primary" bindtap="getWXContext" :loading="loading" >
            \u83B7\u53D6WXContext
        </wx-button>
...
var require_upload_file = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/upload-file/upload-file.wxml"() {
    ...
    page.template = `<div>
        ...
        <wx-textarea class="weui-textarea" :value="fileId" style="height: 3.3em" >
            
        </wx-textarea>
    
        </wx-view>
    
        <wx-view class="weui-cell page-section-ctn" >
            
        <wx-image :src="filePath" class="image" mode="aspectFit" >
        ...
        <wx-view class="btn-area" :v-if="fromOtherPage" >
            
        <wx-navigator open-type="navigateBack" >
            
        <wx-button type="primary" size="40" >
            \u8FD4\u56DE
        </wx-button>
...
var require_download_file = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/download-file/download-file.wxml"() {
    ...
    page.template = `<div>
        ...
        <wx-button type="primary" size="40" bindtap="downloadFile" :loading="loading" >
            \u4E0B\u8F7D\u6587\u4EF6
        </wx-button>
...
var require_get_temp_file_url = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/get-temp-file-url/get-temp-file-url.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'getTempFileURL'}" >
        ...
        <wx-textarea class="weui-textarea" :value="tempFileURL" style="height: 3.3em" >
        ...
        <wx-image :src="tempFileURL" class="image" mode="aspectFit" >
        ...
        <wx-button type="primary" size="40" bindtap="getTempFileURL" :loading="loading" >
            \u6362\u53D6\u4E34\u65F6\u94FE\u63A5
        </wx-button>
...
var require_delete_file = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/delete-file/delete-file.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'deleteFile'}" >
        ...
        <wx-navigator url="/page/cloud/pages/upload-file/upload-file?fro" >
        ...
        <wx-button type="primary" size="40" bindtap="deleteFile" :loading="loading" >
            \u5220\u9664\u6587\u4EF6
        </wx-button>
...
var require_cloud_file_component = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/cloud-file-component/cloud-file-component.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'Component Support'}" >
        ...
        <wx-textarea class="weui-textarea" :value="imageFileId" style="height: 3.3em" >
        ...
        <wx-image :src="imageFileId" class="image" mode="aspectFit" >
        ...
        <wx-textarea class="weui-textarea" :value="videoFileId" style="height: 3.3em" >
        ...
        <wx-video :src="videoFileId" :show-center-play-btn="false" >
...
var require_crud = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/crud/crud.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'CRUD'}" >
        ...
        <wx-view class="weui-cell__hd" style="margin-right: 10rpx" >
            
        <wx-icon type="search" size="20" >
        ...
        <wx-input class="weui-input" placeholder="\u7CBE\u786E\u641C\u7D22\u6216\u4F7F\u7528\u6B63\u5219\u8868\u8FBE\u5F0F\u641C\u7D22" :value="searchContent" bindinput="onInputSearchContent" bindconfirm="searchTodo" >
        ...
        <wx-view v-for="item in todoList" class="weui-cell weui-cell_access" hover-class="weui-cell_active" :data-id="item._id" bindtap="toDetail" >
            
        <wx-view class="weui-cell__hd" :data-id="item._id" :data-index="index" catchtap="toggleComplete" style="margin-right: 10rpx" >
            
        <wx-icon type="circle" :v-if="!item.done" >
            
        </wx-icon>
    
        <wx-icon type="success" >
        ...
        <wx-input class="weui-input" placeholder="\u6DFB\u52A0\u65B0\u7684 Todo" :value="newContent" :focus="todoListFetched && !todoList.length" bindinput="onInputNewContent" bindconfirm="createTodo" >
...
var require_crud_detail = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/crud-detail/crud-detail.wxml"() {
    ...
    page.template = `<div>
        ...
        <wx-input class="weui-input" placeholder="\u8BF7\u8F93\u5165\u5185\u5BB9" :value="description" bindinput="onInputContent" >
        ...
        <wx-button type="primary" size="40" bindtap="updateTodo" :loading="updating" >
            \u66F4\u65B0Todo
        </wx-button>
    
        <wx-button type="warn" size="40" bindtap="removeTodo" :loading="deleting" >
            \u5220\u9664Todo
        </wx-button>
...
var require_db_permission = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/db-permission/db-permission.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'Permission'}" >
        ...
        <wx-view class="weui-select permission-select" >
        ...
        <div :v-if="currentPermissionIndex" >
        ...
        <wx-view :id="index" :class="weui-navbar__item activeTabIndex" bindtap="onTabClick" >
        ...
        <wx-view class="weui-navbar__slider" :style="left: sliderLeftpx; transform: translateX({{sliderOffset}}px); -webkit-transform: translateX({{sliderOffset}}px);" >
        ...
        <wx-view class="weui-tab__content" :hidden="activeTabIndex " >
        ...
        <wx-input class="weui-input" placeholder="\u8BF7\u8F93\u5165\u4E2A\u6027\u7B7E\u540D" :value="myWhatsUp" :focus="!hasMyWhatsUp" data-name="myWhatsUp" bindinput="bindInput" bindconfirm="updateMyWhatsUp" >
        ...
        <wx-button type="primary" bindtap="updateMyWhatsUp" :loading="updating" >
            \u8BBE\u7F6E\u4E2A\u6027\u7B7E\u540D
        </wx-button>
    
        <wx-button bindtap="queryMyWhatsUp" :loading="querying" >
            \u83B7\u53D6\u4E2A\u6027\u7B7E\u540D
        </wx-button>
        ...
        <wx-input class="weui-input" placeholder="\u8BF7\u8F93\u5165\u4E2A\u6027\u7B7E\u540D" :value="adminWhatsUp" data-name="adminWhatsUp" bindinput="bindInput" >
        ...
        <wx-button type="primary" bindtap="updateAdminWhatsUp" :loading="updating" >
            \u8BBE\u7F6E\u4E2A\u6027\u7B7E\u540D
        </wx-button>
    
        <wx-button bindtap="queryAdminWhatsUp" :loading="querying" >
            \u83B7\u53D6\u4E2A\u6027\u7B7E\u540D
        </wx-button>
        ...
        <div :v-elif="currentPermissionIndex" >
        ...
        <wx-input class="weui-input" placeholder="\u8BF7\u8F93\u5165\u90AE\u7BB1" :value="myEmail" data-name="myEmail" bindinput="bindInput" >
        ...
        <wx-button type="primary" bindtap="updateMyEmail" :loading="updating" >
            \u8BBE\u7F6E\u90AE\u7BB1
        </wx-button>
    
        <wx-button bindtap="queryMyEmail" :loading="querying" >
            \u83B7\u53D6\u90AE\u7BB1
        </wx-button>
        ...
        <wx-input class="weui-input" placeholder="\u8BF7\u8F93\u5165\u90AE\u7BB1" :value="adminEmail" data-name="adminEmail" bindinput="bindInput" >
        ...
        <wx-button type="primary" bindtap="updateAdminEmail" :loading="updating" >
            \u8BBE\u7F6E\u90AE\u7BB1
        </wx-button>
    
        <wx-button bindtap="queryAdminEmail" :loading="querying" >
            \u83B7\u53D6\u90AE\u7BB1
        </wx-button>
        ...
        <wx-input class="weui-input" placeholder="\u8BF7\u8F93\u5165\u5546\u54C1\u4EF7\u683C" :value="product.price" data-name="product.price" bindinput="bindInput" >
        ...
        <wx-button type="primary" bindtap="updateProductPrice" :loading="updating" >
            \u8BBE\u7F6E\u5546\u54C1\u4EF7\u683C
        </wx-button>
    
        <wx-button bindtap="queryProduct" :loading="querying" >
            \u83B7\u53D6\u5546\u54C1\u4EF7\u683C
        </wx-button>
        ...
        <wx-input class="weui-input" placeholder="\u8BF7\u8F93\u5165\u540E\u53F0\u6D41\u6C34\u6570\u636E" :value="serverData" data-name="serverData" bindinput="bindInput" >
        ...
        <wx-button type="primary" bindtap="updateServerData" :loading="updating" >
            \u8BBE\u7F6E\u540E\u53F0\u6D41\u6C34\u6570\u636E
        </wx-button>
    
        <wx-button bindtap="queryServerData" :loading="querying" >
            \u83B7\u53D6\u540E\u53F0\u6D41\u6C34\u6570\u636E
        </wx-button>
...
var require_server_date = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/server-date/server-date.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'db.serverDate'}" >
        ...
        <wx-text class="page-body-text" >
            \u5728\u5C0F\u7A0B\u5E8F\u7AEF\u4F7F\u7528Date\u5BF9\u8C61\u521B\u5EFA\u7684\u662F\u5BA2\u6237\u7AEF\u65F6\u95F4\uFF08\u53EF\u88AB\u4EFB\u610F\u4FEE\u6539\uFF09\uFF0C\u800C\u975E\u670D\u52A1\u7AEF\u65F6\u95F4
        </wx-text>
    
        <wx-text class="page-body-text" >
            \u8FD9\u65F6\u53EF\u4EE5\u4F7F\u7528\u4E91\u5F00\u53D1\u63D0\u4F9B\u7684serverDate\u5BF9\u8C61\uFF0C\u5728\u8BF7\u6C42\u88AB\u5904\u7406\u65F6\u4F1A\u81EA\u52A8\u8F6C\u6362\u6210\u670D\u52A1\u7AEF\u65F6\u95F4
        </wx-text>
        ...
        <wx-button type="primary" bindtap="insertData" :loading="loading" >
            \u63D2\u5165\u6570\u636E
        </wx-button>
...
var require_scf_database = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/scf-database/scf-database.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'Database'}" >
        ...
        <wx-image :v-if="theme" src="/page/API/resources/kind/device_dark.png" class="progress-icon" >
            
        </wx-image>
    
        <wx-image v-else src="/page/API/resources/kind/device.png" class="progress-icon" >
            
        </wx-image>
    
        <wx-text :class="progress-line lg clientLoading && 'pending' {{serverDataClient && 'success'}} {{serverDataClientError && 'fail'}}" >
            
        </wx-text>
    
        <wx-image :v-if="theme" src="/page/cloud/resources/kind/database_dark.png" class="progress-icon" >
            
        </wx-image>
    
        <wx-image v-else src="/page/cloud/resources/kind/database.png" class="progress-icon" >
        ...
        <wx-view class="data-text" :v-elif="serverDataClientError" >
            
        <wx-icon type="warn" color="#F43530" >
        ...
        <wx-button bindtap="queryServerDataViaClient" :loading="clientLoading" >
            \u5C0F\u7A0B\u5E8F\u7AEF\u83B7\u53D6\u540E\u53F0\u6D41\u6C34\u6570\u636E
        </wx-button>
        ...
        <wx-text :class="progress-line cloudLoading && 'pending' {{serverDataCloud && 'success'}} {{serverDataCloudError && 'fail'}}" >
            
        </wx-text>
    
        <wx-image :v-if="theme" src="/page/cloud/resources/kind/scf_dark.png" class="progress-icon" >
            
        </wx-image>
    
        <wx-image v-else src="/page/cloud/resources/kind/scf.png" class="progress-icon" >
        ...
        <wx-view class="data-text" :v-elif="serverDataCloudError" >
        ...
        <wx-button bindtap="queryServerDataViaCloudFunction" :loading="cloudLoading" >
            \u8C03\u7528\u4E91\u51FD\u6570\u83B7\u53D6\u540E\u53F0\u6D41\u6C34\u6570\u636E
        </wx-button>
...
var require_scf_storage = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/scf-storage/scf-storage.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: 'Storage'}" >
...
var require_scf_openapi = __commonJS({
  "miniprogram-demo/miniprogram/packageCloud/pages/scf-openapi/scf-openapi.wxml"() {
    ...
    page.template = `<div>
        ...
        <component is="head" :data="{title: '\u4E91\u51FD\u6570\u4E2D\u4F7F\u7528\u5FAE\u4FE1\u5F00\u653E\u80FD\u529B'}" >
        ...
        <wx-text :class="progress-line sendTemplateMessageLoading && 'pending' {{sendTemplateMessageResult && 'success'}} {{sendTemplateMessageError && 'fail'}}" >
        ...
        <wx-view class="data-text" :v-elif="sendTemplateMessageError" >
        ...
        <wx-form bindsubmit="sendTemplateMessageViaCloudFunction" >
            
        <wx-button form-type="submit" :loading="cloudLoading" >
            \u53D1\u9001\u6A21\u677F\u6D88\u606F
        </wx-button>
        ...
        <wx-text :class="progress-line getWXACodeLoading && 'pending' {{getWXACodeResult && 'success'}} {{getWXACodeError && 'fail'}}" >
        ...
        <wx-image :src="getWXACodeResult.result" mode="aspectFit" >
        ...
        <wx-view class="data-text" :v-elif="getWXACodeError" >
        ...
        <wx-button bindtap="getWXACodeViaCloudFunction" :loading="cloudLoading" >
            \u83B7\u53D6\u5C0F\u7A0B\u5E8F\u7801
        </wx-button>
